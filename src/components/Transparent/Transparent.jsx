    ...
    return (
      <div className="py-30 container mx-auto flex flex-col gap-8 justify-center items-center">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="card w-96 bg-base-100 shadow-sm">
            <div className="card-body rounded-2xl">
              ...
              <div className="flex flex-col justify-between">
                ...
                <span className="text-gray-400 text-xl mt-6">
                  <span className="text-black font-bold text-3xl ">$0</span>
                  /Month
                </span>
              </div>
              <ul className="mt-6 flex flex-col gap-2 text-xs">
                <li>
                  ...
                  <span className="text-gray-400">Access to 10 free tools</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="mt-6">
                <button className="btn bg-linear-to-tr from-[#4F39F6] to-[#9514FA] text-white btn-block rounded-full">
                  Get Started Free
                </button>
              </div>
            </div>
          ...
          <div className="  card w-96 bg-base-100 shadow-sm">
            <div className="relative rounded-2xl card-body bg-linear-to-tr from-[#4F39F6] to-[#9514FA] text-white">
              <span className="absolute -top-2 right-38 badge text-xs badge-warning rounded-full">
                Most Popular
              </span>
              <div className="flex flex-col justify-between">
              ...
              <div className="mt-6">
                <button className="btn bg-white text-[#9514FA] btn-block rounded-full">
                  Get Started Free
                </button>
              </div>
            </div>
          ...
          <div className="card w-96 bg-base-100 shadow-sm">
            <div className="card-body rounded-2xl">
              ...
              <div className="flex flex-col justify-between">
                ...
                <span className="text-gray-400 text-xl mt-6">
                  <span className="text-black font-bold text-3xl ">$99</span>
                  /Month
                </span>
              </div>
              <ul className="mt-6 flex flex-col gap-2 text-xs">
